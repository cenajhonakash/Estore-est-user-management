...
public class QueryConstant {
	private static final String FETCH_USER_AND_ROLE_DETAILS = """
			select new com.ace.estore.userprofile.response.dto.UserRoleDetailsDto(us.firstName as firstName,  us.lastName as lastName,  us.username as username,
			us.phone as contact,  us.email as email, rol.roleName as role)
